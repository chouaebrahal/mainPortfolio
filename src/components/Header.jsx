        ...
        <div className="flex gap-5 text-primary cursor-pointer">
          {isOpen ? (
            <X
              ...
              className="w-5 h-5  hover:text-third duration-300 transition-all hover:scale-[1.06]"
            />
          ) : (
            <Menu
              onClick={() => setIsOpen((prev) => !prev)}
          ...
          <a href="https://www.linkedin.com/in/chouaeb-rahal/" target="_blank" rel="noopener noreferrer">
            <svg
          ...
          <a href="https://github.com/chouaebrahal/" target="_blank" rel="noopener noreferrer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
